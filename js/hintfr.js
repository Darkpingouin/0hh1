...
var HintType = {
  None: 'Aucun',
  RowsMustBeUnique: 'Chaque ligne doit être unique.',
  ColsMustBeUnique: 'Chaque colone doit être unique.',
  RowMustBeBalanced: 'Une ligne doit avoir un nombre égal de tuiles rouges et de tuiles bleues.',
  ColMustBeBalanced: 'Une colone doit avoir un nombre égal de tuiles rouges et de tuiles bleues.',
  MaxTwoRed: 'Il est interdit d\'avoir trois tuiles rouges consécutives.',
  MaxTwoBlue: 'Il est interdit d\'avoir trois tuiles bleues consécutives.',
  ...
  Error: 'Cela n\'a pas l\'air d\'être juste.',
  Errors: 'Tu as fait plusieurs erreurs.'
};
